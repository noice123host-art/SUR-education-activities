        ...
        while _G.MainFarm do
            pcall(function()
                ...
                if myBoss then
                    ...
                    hrp.CFrame = myBoss.HumanoidRootPart.CFrame * CFrame.new(0, -8, 2.5) * CFrame.Angles(math.rad(90), 0, 0)
                    ...
                    if hrp.Position.X < 5000 then 
                        ...
                        if SelectedNPCData.Name == "i_stabman" then
                            if (hrp.Position - POS_MAIN_STABMAN).Magnitude > 15 then
                                hrp.CFrame = CFrame.new(POS_MAIN_STABMAN) * CFrame.new(0, 2, 0)
                                task.wait(0.5)
                            end
                        elseif SelectedNPCData.Name == "Apex_Lvl500" then
                            if (hrp.Position - POS_APEX).Magnitude > 15 then
                                hrp.CFrame = CFrame.new(POS_APEX) * CFrame.new(0, 2, 0)
                                task.wait(0.5)
                            end
                        end
                    else
                        ...
                        if myNPC and (hrp.Position - myNPC:GetModelCFrame().Position).Magnitude > 10 then
                            hrp.CFrame = myNPC:GetModelCFrame() * CFrame.new(0, 2, 3)
                            task.wait(0.3)
                        end
                    end
            ...
            task.wait(0.15) -- Tốc độ quét nhanh hơn để không lỡ Boss
        end
    end)
end)
